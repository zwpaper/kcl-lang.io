# 喜报！KCL 正式成为 CNCF 沙盒项目 🎉

![kcl-joining-cncf-sandbox](./kcl-joining-cncf-sandbox.png)
...
![cncf-sandbox-logo](./cncf-sandbox-logo.png)
...
![standalone-kcl-form](./standalone-kcl-form.png)
...
![practice-krm-kcl](./practice-krm-kcl.png)
...
![practice-konfig-gitops](./practice-konfig-gitops.png)
